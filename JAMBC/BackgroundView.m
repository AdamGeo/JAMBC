...
#define FILL_OPACITY 1.0f // 0.9f
#define STROKE_OPACITY 0 // 1.0f

#define LINE_THICKNESS 2.0f // 1.0f
#define CORNER_RADIUS 10.0f // 6.0f
...
//    [path setLineWidth:LINE_THICKNESS * 8];
